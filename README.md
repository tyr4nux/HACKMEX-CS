...
```bash
sudo nmap -sT -vvv -oN scan.txt -Pn -p21,22,80,111,389,1883,2718,3000,4000,4567,5000,5050,5572,5672,5678,6379,8000,8080,8081,8161,8443,9000,61613,61614,61616
 10.10.10.10
```
